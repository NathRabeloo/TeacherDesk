          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-lg text-gray-600 dark:text-gray-300 mt-1">
                  Gerencie seus planos de aula de forma organizada e eficiente
                </p>
              </div>
            </div>
            ...
            <div className="hidden lg:flex items-center space-x-6">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Planos</p>
              </div>
              <div className="text-center">
      ...
      <div className="bg-white dark:bg-gray-800 mt-12 border-t border-gray-200 dark:border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="text-center text-gray-600 dark:text-gray-400">
            <p className="text-lg">Sistema de Diários de Aula</p>
            <p className="text-sm mt-2">Organize seus planos de ensino de forma eficiente</p>
          </div>
        </div>
      </div>
    </div>
