      ...
      >
        ...
        <div className="w-full max-w-md space-y-6 relative z-20"> 
          ...
          <div className="text-center">
            <h1 className="text-2xl font-bold text-blue-800">Recuperar Senha</h1>
          ...
          <form className="space-y-5" action={forgotPasswordAction}>
            ...
            <SubmitButton className="w-full bg-blue-700 hover:bg-blue-800 text-white" pendingText="Redefinindo...">
              Redefinir Senha
            </SubmitButton>
