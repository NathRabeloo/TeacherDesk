        ...
        <div className="flex flex-col items-center space-y-6 p-6">
            ...
            <div className="relative">
                ...
                <div className="absolute top-1/2 right-0 z-10 transform translate-x-1/2 -translate-y-1/2">
                    <div className="w-0 h-0 border-l-[20px] border-l-transparent border-r-[20px] border-r-transparent border-b-[30px] border-b-gradient-to-r from-yellow-400 to-yellow-600 rotate-90 drop-shadow-lg">
                    </div>
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-0 h-0 border-l-[18px] border-l-transparent border-r-[18px] border-r-transparent border-b-[28px] border-b-yellow-500 rotate-90">
                    </div>
                </div>
            ...
            <button
                onClick={spin}
                disabled={spinning}
                className={`group relative overflow-hidden px-8 py-4 rounded-2xl font-bold text-lg transition-all duration-300 transform ${
                    spinning 
